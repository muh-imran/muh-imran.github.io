...
---
### Journal Articles
* Imran, M. (2025). A multi-party quantum private set intersection based on greatest common divisor. International Journal of Quantum Information, 23(2).

* Imran, M. & Ivanyos, G. (2024). Efficient quantum algorithms for some instances of the semidirect discrete logarithm problem. Designs, Codes, and Cryptography, 92(10).

* Imran, M. & Ivanyos, G. (2024). Zero sum subsequences and hidden subgroups. Quantum Information Processing, 23(1).
...
* Damara, B., Imran, M., & Sugeng, K.A. (2025). The shifted discrete logarithm problem and its applications in post-quantum cryptography. International Conference on Cryptography, Informatics and Cybersecurity - ICoCICs 2025.
